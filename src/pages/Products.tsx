      ...
      <div>
        ...
        <div className="mt-6 space-y-4 text-gray-600">
          <p>
            ...
            bærekraftig, lokalt skogbruk. Hele prosessen - fra skogen til ferdig
            ved - utføres av oss. Vi står selv for produksjon, tørking, pakking
            og utlevering, slik at vi kan sikre høy kvalitet i alle ledd.
          </p>
          <p>
            ...
            utlandet. Ved å velge lokal ved reduseres transporten, samtidig som
            du støtter bærekraftig skogbruk og lokal verdiskaping.
          </p>
          <p>
            Vår ved er godt tørket og klar til bruk, og vi legger stor vekt på
            pålitelig service, god kvalitet og fornøyde kunder. Når du handler
            hos oss, vet du hvor veden kommer fra - og hvem som har produsert
            den.
          </p>
        </div>
      </div>
